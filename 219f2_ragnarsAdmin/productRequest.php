<?php
     ...
     $pageTitle = "Ragnars E-Ticaret - Product Request Panel";
     include "../config.php";
     ...
     <main>
          ...
          <div class="tableArea">
               <table id="myTable" class="display responsive nowrap" style="width:100%">
                    ...
                    <tbody>
                              <?php
                                   $sql = $db -> query("SELECT * FROM 219f2_productRequest");
                              ...
                              <tr>
                                   <th> <?= $data['id']; ?></th>
                                   <th><a href="#" name="environment" productHash="<?= $data['productHash']; ?>"><i class="fa-brands fa-envira"></i></a> <a href="#" name="rare" productHash="<?= $data['productHash']; ?>"><i class="fa-solid fa-check"></i></a> <a href="#" name="productDel" productHash="<?= $data['productHash']; ?>"><i class="fa-solid fa-trash-can"></i></a></th>
                                   <th><img width=100 height=100 src="../assets/media/products/<?= $file; ?>" alt="<?= $data['productName']; ?>"></th>
