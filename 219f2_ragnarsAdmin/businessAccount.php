<?php
     ...
     $pageTitle = "Ragnars E-Ticaret - Business Account";
     include "../config.php";
...
<head>
     ...
     <link rel="stylesheet" href="assets/css/frontCss/businessAccount.css">
     <link rel="stylesheet" href="assets/css/mediaCss/businessAccountMedia.css">
...
<body>
     ...
     <main>
          ...
          <div class="tableArea">
               <table id="myTable" class="display responsive nowrap" style="width:100%">
                    ...
                    <tbody>
                              <?php
                                   $sql = $db -> query("SELECT * FROM 219f2_users WHERE accountType = 'business'");
                              ...
                              <tr>
                                   <th> <?= $data['id']; ?></th>
                                   <th><a style="cursor: pointer;" name="bDel" userHash="<?= $data['hash']; ?>"><i class="fa-solid fa-trash" title="Hesabı Kaldır"></i></a></th>
     ...
     <script src="assets/js/businessAccountDel.js"></script>
     <?php
